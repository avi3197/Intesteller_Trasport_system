...
@ContextConfiguration(classes = {Traffic.class, DaoForTraffics.class, DB.class, HibernateBean.class},
        loader = AnnotationConfigContextLoader.class)
public class TrafficDaoTest {
    @Autowired
    private SessionFactory sessionFactory;
    private DaoForTraffics DaoForTraffics;

    @Before
    public void setUp() throws Exception {
        DaoForTraffics = new DaoForTraffics(sessionFactory);
    }
    ...
    public void verifyThatUpdateTrafficIsCorrect() throws Exception {
        ...
        //Test
        DaoForTraffics.update(trafficToUpdate);
        Criteria criteria = session.createCriteria(Traffic.class);
        List<Traffic> persistedTraffics = (List<Traffic>) criteria.list();
    ...
    public void verifyThatDeleteTrafficIsCorrect() throws Exception {
        ...
        //Test
        DaoForTraffics.delete(traffic2.getRouteId());
        Criteria criteria = session.createCriteria(Traffic.class);
        List<Traffic> persistedTraffics = (List<Traffic>) criteria.list();
    ...
    public void verifyThatSelectUniqueTrafficIsCorrect() throws Exception {
        ...
        //Test
        Traffic persisted = DaoForTraffics.selectUnique(expected.getRouteId());
    ...
    public void verifyThatSelecteAllTrafficsIsCorrect() throws Exception {
        ...
        //Test
        List<Traffic> persistedTraffics = DaoForTraffics.selectAll();
    ...
    public void verifyThatSelectEdgeMaxRecordIsCorrect() {
        ...
        //Test
        long returnMax = DaoForTraffics.selectMaxRecordId();
    ...
    public void verifyThatEdgeExistsSelectionIsCorrect() {
        ...
        //Test
        List<Traffic> returnedEdges = DaoForTraffics.trafficExists(trafficToCommit);
        //Verify

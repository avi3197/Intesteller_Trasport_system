...
@ContextConfiguration(classes = {Vertex.class, DaoForVertex.class, DB.class, HibernateBean.class},
        loader = AnnotationConfigContextLoader.class)
public class VertexDaoTest {
    @Autowired
    private SessionFactory sessionFactory;
    private DaoForVertex DaoForVertex;

    @Before
    public void setUp() throws Exception {
        DaoForVertex = new DaoForVertex(sessionFactory);
    }
    ...
    public void verifyThatUpdateVertexIsCorrect() throws Exception {
        ...
        //Test
        DaoForVertex.update(vertexToUpdate);
        Criteria criteria = session.createCriteria(Vertex.class);
        List<Vertex> persistedVertexes = (List<Vertex>) criteria.list();
    ...
    public void verifyThatDeleteVertexIsCorrect() throws Exception {
        ...
        //Test
        DaoForVertex.delete(v2.getVertexId());
        Criteria criteria = session.createCriteria(Vertex.class);
        List<Vertex> persistedVertexes = (List<Vertex>) criteria.list();
    ...
    public void verifyThatSelectUniqueVertexIsCorrect() throws Exception {
        ...
        //Test
        Vertex actualVertex = DaoForVertex.selectUnique(expected.getVertexId());
    ...
    public void verifyThatSelectUniqueByNameVertexIsCorrect() throws Exception {
        ...
        //Test
        Vertex persistedVertex = DaoForVertex.selectUniqueByName(expected.getName());
    ...
    public void verifyThatSelectAllVertexIsCorrect() throws Exception {
        ...
        //Test
        List<Vertex> persistedVertexes = DaoForVertex.selectAll();

...
@ContextConfiguration(classes = {DaoForTraffics.class, DaoForEdges.class, DaoForVertex.class, DB.class, HibernateBean.class},
...
public class EntityManagerServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        entityManagerService = new EntityManagerService(DaoForVertex, DaoForEdges, DaoForTraffics);
    }

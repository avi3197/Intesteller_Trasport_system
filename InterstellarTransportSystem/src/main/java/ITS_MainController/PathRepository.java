...
public class PathRepository {
    ...
    private VertexAndEdgesGraph graph;
    private EntityManagerService entityManagerService;

    @Autowired
    public PathRepository(@Qualifier("transactionManager") PlatformTransactionManager platformTransactionManager, EntityManagerService entityManagerService) {
